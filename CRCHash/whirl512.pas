...
(*************************************************************************
 ...
 REQUIREMENTS    :  TP5-7, D1-D7/D9-D10/D12/D17-D18, FPC, VP (386+, undef BASM16 for 286)
...
procedure Whirl_File({$ifdef CONST} const {$endif} fname: Str255;
...
const
  Whirl_OID : TOID_Vec = (1,0,10118,3,0,55,-1,-1,-1); {Len=6}
